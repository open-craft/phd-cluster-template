...
def _configure_argo_workflows_user(
    ...
    run_command_with_logging(
        ...
        data={
            f"accounts.{username}.enabled": enabled_b64,
            f"accounts.{username}.password": hash_b64,
            f"accounts.{username}.tokens": tokens_b64,
        },
    )
...
def _configure_argocd_user(
    ...
    argocd_cm.data[f"accounts.{username}"] = "login"
    ...
    run_command_with_logging(
        ...
        name="argocd-secret",
        namespace=ARGOCD_NAMESPACE,
        data={f"accounts.{username}.password": hash_b64},
    )
...
""",
    ...
    token = _wait_for_token_generation(k8s_client, username)
    ...
    run_command_with_logging(
        ...
        namespace=ARGO_NAMESPACE,
        string_data={
            f"accounts.{username}.tokens": token,
        },
    )
